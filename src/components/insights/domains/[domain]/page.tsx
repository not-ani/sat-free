...
export default function DomainDetailPage({
  ...
  const { results, loadMore, status } = usePaginatedQuery(
    api.myFunctions.listMyAttemptsByDomainPaginated,
    { domain },
    { initialNumItems: 20 }
  );
  ...
  return (
    <div className="container mx-auto space-y-6 py-6">
      <div className="mb-2">
        <h1 className="font-semibold text-2xl">Domain · {domain}</h1>
        <p className="text-muted-foreground">Your attempts for this domain.</p>
      </div>
